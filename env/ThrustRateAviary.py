...
from gym_pybullet_drones.utils.enums import DroneModel, Physics, ObservationType, ImageType
...
class ActionType(Enum):
    ...
    TR = "tr"                   # Thrust and angular rates

class ThrustRateAviary(BaseAviary):
